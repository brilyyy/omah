      ...
      <DialogContent className="sm:max-w-sm">
        <DialogHeader>
          ...
          <DialogDescription className="text-center leading-relaxed">
            omah is free and open-source. If it saves you time, consider supporting continued
        ...
        <DialogFooter className="flex-col gap-2 sm:flex-col">
          ...
          <div className="flex gap-2">
            ...
            <Button variant="ghost" className="flex-1 text-muted-foreground" onClick={handleLater}>
              Maybe later
            </Button>
          </div>
        </DialogFooter>
